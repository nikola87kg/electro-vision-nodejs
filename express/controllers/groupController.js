...
exports.getAllGroups = async (req, res, next) => {
    try {
        ...
        let groupList = await Group.find().populate("category", [
            "_id",
            "name",
            "slug",
        ]);
        ...
        console.error(
            "\x1b[41m",
            "Error during getting all groups --> ",
            e,
            "\x1b[0m"
        );
    }
...
exports.getOneGroup = async (req, res, next) => {
    try {
        ...
        const singleGroup = await Group.findOne({
        ...
        console.error(
            "\x1b[41m",
            "Error during getting single group --> ",
            e,
            "\x1b[0m"
        );
    }
